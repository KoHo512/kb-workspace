...
public class BoardApiController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "요청이 성공적으로 처리되었습니다.", response = BoardDTO.class),
    ...
    @ApiOperation(value = "게시글 상세 정보", notes = "게시글 상세 정보를 얻는 API")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "요청이 성공적으로 처리되었습니다.", response = BoardDTO.class),
            @ApiResponse(code = 400, message = "잘못된 요청입니다."),
            @ApiResponse(code = 500, message = "서버에서 오류가 발생했습니다.")
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "요청이 성공적으로 처리되었습니다."),
            @ApiResponse(code = 400, message = "잘못된 요청입니다."),
            @ApiResponse(code = 500, message = "서버에서 오류가 발생했습니다.")
    })
    @DeleteMapping("/{no}")
